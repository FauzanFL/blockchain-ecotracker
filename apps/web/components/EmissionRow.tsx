...
export const EmissionRow = ({ log }: EmissionRowProps) => {
  ...
  return (
    <motion.div
      ...
      className="px-6 py-4 flex justify-between items-center hover:bg-white/3 transition-colors group"
    >
      ...
      <div className="flex flex-col items-end md:items-center">
        <span className="text-lg font-bold text-white tracking-tight group-hover:text-emerald-400 transition-colors">
          {log.amount} <span className="text-xs font-normal text-gray-500">kg</span>
        </span>
      </div>
